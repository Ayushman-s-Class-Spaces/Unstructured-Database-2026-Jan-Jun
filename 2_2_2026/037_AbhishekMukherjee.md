...
db["sectiond"].insertOne({Roll : 001 , name : "Abhishek Mukherjee" , department : "computer science"})
{
  acknowledged: true,
  insertedId: ObjectId('698034cf632dd840f74c75a2')
}

db["sectiond"].insertOne({Roll : 002 , name : "rick mukherjee" , department : "computer science"})
